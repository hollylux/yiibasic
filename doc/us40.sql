...
-- Dumping data for table mph.product: 30 rows
DELETE FROM `product`;
...
INSERT INTO `product` (`id`, `name`, `description`, `status`, `images`, `my_price`, `us_price`, `us_cost`, `us_url`, `cn_price`, `cn_url`, `created_at`, `updated_at`, `category`, `favnum`, `soldnum`) VALUES
	...
	(17, '美国原装进口Thinkbaby内不锈钢无BPA宝宝餐具套装 多色可选', 'The Complete BPA Free Feeding Set', 1, '170607161601thinkbabyfeedset.jpg', 398.00, 35.00, 335.00, 'https://smile.amazon.com/dp/B00HT6EAUE/', 450.00, 'https://item.jd.hk/1075239113.html', '2017-06-07 16:16:11', '2017-06-13 18:21:06', 2, 1, 4),
	...
	(21, '美国发货JBL GO 音乐金砖 蓝牙音箱 低音炮 便携迷你 多色可选', 'Full-featured, great-sounding, great-value portable speaker', 1, '170609175802jbl_go.jpg', 278.00, 19.95, 196.00, 'http://www.jbl.com/JBLGOBLUE.html', 298.00, 'http://item.jd.com/1436718.html', '2017-06-09 17:58:06', '2017-06-09 18:28:20', 20, 1, 0),
